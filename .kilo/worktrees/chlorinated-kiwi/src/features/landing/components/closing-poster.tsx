  ...
  return (
    <section className="bg-brand text-white">
      <div className="mx-auto max-w-[1320px] px-[clamp(20px,4vw,48px)] py-[clamp(56px,9vw,128px)]">
        <Reveal>
          <div className="text-2xs font-bold tracking-[.16em] uppercase opacity-85">
            09 — What it changes
          </div>
          ...
          <div className="mt-[clamp(28px,4vw,44px)] flex flex-wrap gap-3">
            <Button
              asChild
              className="h-12 bg-white px-5.5 text-base text-ink hover:bg-white/85"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="h-12 border-white/60 bg-transparent px-5.5 text-base text-white hover:bg-white/15 hover:text-white"
            >
